...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const sugestoes = [
    { texto: "Criação de sites",        alvo: "#servicos" },
    { texto: "Vida aos cartazes",       alvo: "#servicos" },
    { texto: "Como funciona o processo", alvo: "#como-funciona" },
    { texto: "Sobre a nossa equipa",    alvo: "#sobre" },
    { texto: "Perguntas frequentes",    alvo: "#faq" },
    { texto: "Novos serviços em breve", alvo: "#brevemente" },
    { texto: "Falar no WhatsApp",       alvo: "#contacto" },
    { texto: "Contacto e email",        alvo: "#contacto" }
  ];
  ...
  function desenharSugestoes(lista) {
    ...
    lista.forEach(function (item) {
      ...
      li.addEventListener("click", function () {
        fecharCaixaPesquisa();
        const destino = document.querySelector(item.alvo);
